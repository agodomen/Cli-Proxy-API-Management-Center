...
import { DashboardPage } from '@/external/pages/DashboardPage';
import { externalRoutes } from '@/external/router/externalRoutes';
import { ProvidersWorkbenchPage } from '@/external/features/providers/ProvidersWorkbenchPage';
import { AuthFilesPage } from '@/external/pages/AuthFilesPage';
import { AuthFilesOAuthExcludedEditPage } from '@/pages/AuthFilesOAuthExcludedEditPage';
import { AuthFilesOAuthModelAliasEditPage } from '@/pages/AuthFilesOAuthModelAliasEditPage';
import { OAuthPage } from '@/external/pages/OAuthPage';
import { QuotaPage } from '@/pages/QuotaPage';
import { PluginResourcePage } from '@/features/plugins/PluginResourcePage';
import { PluginsPage } from '@/features/plugins/PluginsPage';
import { PluginStorePage } from '@/features/plugins/PluginStorePage';
import { ConfigPage } from '@/pages/ConfigPage';
import { LogsPage } from '@/external/pages/LogsPage';
