...
export const externalRoutes = [
  ...
  { path: '/ai-providers/gemini/new', element: <SuspenseWrap><AiProvidersGeminiEditPage /></SuspenseWrap> },
  { path: '/ai-providers/gemini/:index', element: <SuspenseWrap><AiProvidersGeminiEditPage /></SuspenseWrap> },
  { path: '/ai-providers/codex/new', element: <SuspenseWrap><AiProvidersCodexEditPage /></SuspenseWrap> },
  { path: '/ai-providers/codex/:index', element: <SuspenseWrap><AiProvidersCodexEditPage /></SuspenseWrap> },
  {
  ...
  { path: '/ai-providers/vertex/new', element: <SuspenseWrap><AiProvidersVertexEditPage /></SuspenseWrap> },
  { path: '/ai-providers/vertex/:index', element: <SuspenseWrap><AiProvidersVertexEditPage /></SuspenseWrap> },
  {
  ...
  { path: '/ai-providers/ampcode', element: <SuspenseWrap><AiProvidersAmpcodeEditPage /></SuspenseWrap> },
  { path: '/ai-providers', element: <SuspenseWrap><AiProvidersPage /></SuspenseWrap> },
  { path: '/ai-providers/*', element: <SuspenseWrap><AiProvidersPage /></SuspenseWrap> },
