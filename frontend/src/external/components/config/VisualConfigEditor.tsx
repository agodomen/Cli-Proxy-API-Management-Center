...
} from '@/external/components/config/configSearchIndex';
                    ...
                    <SectionGrid>
                      <FieldAnchor fieldId="codexIdentityConfuse">
                        <ToggleRow
                          ...
                          checked={(values as Record<string, unknown>).codexIdentityConfuse as boolean}
                          disabled={disabled}
                          onChange={(codexIdentityConfuse: boolean) => onChange({ codexIdentityConfuse } as Partial<typeof values>)}
                        />
                      </FieldAnchor>
                    </SectionGrid>
                  </SectionStack>
