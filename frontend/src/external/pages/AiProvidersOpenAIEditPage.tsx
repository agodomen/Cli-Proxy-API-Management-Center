...
import { HeaderInputList } from '@/external/components/ui/HeaderInputList';
...
import { buildApiKeyEntry, buildOpenAIChatCompletionsEndpoint } from '@/external/components/providers/utils';
import type { OpenAIEditOutletContext } from './AiProvidersOpenAIEditLayout';
import type { KeyTestStatus } from '@/external/stores/useOpenAIEditDraftStore';
...
export function AiProvidersOpenAIEditPage() {
  ...
  const renderKeyEntries = (entries: ApiKeyEntry[]) => {
    ...
    const addEntry = () => {
      setForm((prev) => ({ ...prev, apiKeyEntries: [buildApiKeyEntry(), ...list] }));
