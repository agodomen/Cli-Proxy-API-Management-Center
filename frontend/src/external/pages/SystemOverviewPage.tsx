/**
 * System Overview page — independent secondary-dev copy of the dashboard logic.
 *
 * This is a standalone fork of DashboardPage: it carries its own component code
 * and its own SCSS module (SystemOverviewPage.module.scss). Both files live in
 * frontend/src/external/ (Level 1) and are protected from community sync, so
 * the page can evolve independently without being affected by upstream changes
...
import { getDashboardModelsStatValue } from '@/external/utils/dashboard';
import styles from './SystemOverviewPage.module.scss';
...
export function SystemOverviewPage() {
  ...
  const fetchModels = useCallback(async () => {
    ...
    try {
      ...
      // Ignore model fetch errors on overview
    }
