...
import { useServerRuntimeKind } from '@/external/hooks/useServerRuntimeKind';
import { logsApi, type LogsQuery } from '@/external/services/api/logs';
...
import { HTTP_METHODS, STATUS_GROUPS, resolveStatusGroup, type LogState } from '@/pages/hooks/logTypes';
...
export function LogsPage() {
  ...
  const { runtimeKind: serverRuntimeKind, updateRuntimeKind: updateServerRuntimeKind } = useServerRuntimeKind();
