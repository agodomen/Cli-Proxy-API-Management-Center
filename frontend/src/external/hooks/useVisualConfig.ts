      ...
      const newValues: VisualConfigValues = {
        ...
        codexHeaderBetaFeatures:
          typeof codexHeaderDefaults?.['beta-features'] === 'string'
            ...
            : '',
        ...({ codexIdentityConfuse: Boolean(codex?.['identity-confuse']) } as Record<string, unknown>),
    ...
    (currentYaml: string): string => {
      try {
        ...
        if (dirtyFields.has('codexIdentityConfuse')) {
          ...
          setBooleanInDoc(doc, ['codex', 'identity-confuse'], (values as Record<string, unknown>).codexIdentityConfuse as boolean);
