...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.GET("/plugin-proxy", s.mgmt.GetPluginProxyURL)
		mgmt.PUT("/plugin-proxy", s.mgmt.PutPluginProxyURL)
		mgmt.PATCH("/plugin-proxy", s.mgmt.PutPluginProxyURL)
		mgmt.DELETE("/plugin-proxy", s.mgmt.DeletePluginProxyURL)
		mgmt.Any("/plugin-proxy/*path", s.mgmt.PluginProxy)
