...
type Config struct {
	...
	// PluginProxy configures the outbound proxy used only by plugin-store list/install.
	// It is independent from the global proxy-url setting.
